function getProjects() {
  const urlGitHub = "https://api.github.com/users/Iza-Mots/repos"; // Inserir o nome de usuário do seu github
...
function showProjects(data) {
  ...
  data.forEach((repo) => {
    ...
    a.href = repo["https://github.com/Iza-Mots?tab=repositories"]; // Link para o repositório no GitHub
    a.target = "_blank";
